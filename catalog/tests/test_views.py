...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        for author_num in range(number_of_authors):
            Author.objects.create(first_name='Christ %s' % author_num, last_name='Soux %s' % author_num, )
    ...
    def test_lists_remaining_authors(self):
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user2 = User.objects.create_user(username='testuser2', password='12345')
        test_user2.save()
        mark_permission = Permission.objects.get(name='Can set book as returned')
        renew_permission = Permission.objects.get(name='Can renew books')

        # The 'user_permissions.add' method can add one or multiple permissions at once
        test_user2.user_permissions.add(mark_permission, renew_permission)
        test_user2.save()
    ...
    def test_form_invalid_due_backe_future(self):
        login = self.client.login(username='testuser2', password='12345')
